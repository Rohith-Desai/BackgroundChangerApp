...
public class LoveFragmentNew extends Fragment {
    ...
    String img1, img2;
   public static int keycountnewlove = 0;

    RecyclerView neonCateRecNew;

    LoveAdapterListenernew loveAdapterListenernew;
    public interface LoveAdapterListenernew {
        void onLoveItemClickednew(String back, String forei,int position);
    }
    @Override
                        ...
                        if (RemoteConfigValues.getOurRemote().getEnableRewardAfter()!=null){
                            if (!RemoteConfigValues.getOurRemote().getEnableRewardAfter().equals("")){
                                for (int i=Integer.parseInt(RemoteConfigValues.getOurRemote().getEnableRewardAfter())+1;i<=Integer.parseInt(RemoteConfigValues.getOurRemote().getLoveCount());i++){
                                    neonThumb.add(RemoteConfigValues.getOurRemote().getLoveUrl()+"love_thumb_"+i+".jpg");
                                    neonBack.add(RemoteConfigValues.getOurRemote().getLoveUrl()+"love_back_"+i+".png");
                                    neonFore.add(RemoteConfigValues.getOurRemote().getLoveUrl()+"love_fore_"+i+".png");
                                }
                            }
                        }
...
//to check and seperate the frames that are downloaded in natureframes list before  key list
        ...
        for (int i = 0; i < neonThumb.size(); i++) {
            ...
            if (img1.contains("https")) {
                ...
                if (backmediaStorageDir.exists() && foremediaStorageDir.exists()) {
                    ...
                    keycountnewlove = downloadedThumb.size();
                    System.out.println(keycountnewlove);
                } else {
                    //adding the not downloaded frames
    ...
    private void classAndWidgetIntialize() {
        ...
        LoveframesAdapterNew loveframesAdapterNew = new LoveframesAdapterNew(getActivity(), beforeKeydownloadthumb,beforeKeydownloadback,beforeKeydownloadfore);
        ...
        neonCateRecNew.setAdapter(loveframesAdapterNew);


    }
    public class LoveframesAdapterNew  extends RecyclerView.Adapter<LoveframesAdapterNew.ViewHolder> {
        ...
        public LoveframesAdapterNew(Activity activity, ArrayList<String> neonThumb, ArrayList<String> neonBack, ArrayList<String> neonFore){
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            int newkeycount;
            if (keycountnewlove > 0) {
                newkeycount = oldkeycount + keycountnewlove;
...
//                        if (position>=Integer.parseInt(RemoteConfigValues.getOurRemote().getEnableRewardAfter())){
            ...
            holder.neonnewImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(loveAdapterListenernew != null) {
                        loveAdapterListenernew.onLoveItemClickednew(neonBack.get(position),neonFore.get(position),position);
                    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            loveAdapterListenernew = (LoveAdapterListenernew) context;
