...
public class AlarmEvngReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d("inEveningNotification","true");

        SharedPreferences prefs = context.getSharedPreferences("Notifications_Cal_evng", MODE_PRIVATE);
        boolean startServ = prefs.getBoolean("STARTSERVICE", false);
        if (startServ){

            Bundle bundle = new Bundle();
            bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "MorningAlarm");
            ...
            SharedPreferences.Editor editor = context.getSharedPreferences("Notifications_Cal_evng", MODE_PRIVATE).edit();
