...
public class CityFragment extends Fragment {
    ...
    String img1, img2;
    public static int keycountcity = 0;
    ...
    public interface CityFragmentListener {
        void onCityViewItemClicked(String back, String forei, int position);
    }
                        ...
                        if (RemoteConfigValues.getOurRemote().getEnableRewardAfter() != null) {
                            if (!RemoteConfigValues.getOurRemote().getEnableRewardAfter().equals("")) {
                                for (int i = Integer.parseInt(RemoteConfigValues.getOurRemote().getEnableRewardAfter()) + 1; i <= Integer.parseInt(RemoteConfigValues.getOurRemote().getCityCount()); i++) {
                                    animalThumb.add(RemoteConfigValues.getOurRemote().getCityUrl() + "city_thumb_" + i + ".jpg");
                                    animalBack.add(RemoteConfigValues.getOurRemote().getCityUrl() + "city_back_" + i + ".png");
                                    animalFore.add(RemoteConfigValues.getOurRemote().getCityUrl() + "city_fore_" + i + ".png");
                                }
                            }
                        }
                    }
...
//to check and seperate the frames that are downloaded in natureframes list before  key list
        ...
        for (int i = 0; i < animalThumb.size(); i++) {
            ...
            if (img1.contains("https")) {
                ...
                if (backmediaStorageDir.exists() && foremediaStorageDir.exists()) {
                    ...
                    keycountcity = downloadedThumb.size();
                    System.out.println(keycountcity);
                } else {
                    //adding the not downloaded frames
    ...
    private void animalDataonly() {
       /* long seed = System.nanoTime();
        ...
        Collections.shuffle(animalBack, new Random(seed));
        Collections.shuffle(animalFore, new Random(seed));*/
        CityframesAdapter cityframesAdapter = new CityframesAdapter(getActivity(), beforeKeydownloadthumb, beforeKeydownloadback, beforeKeydownloadfore);
        ...
        animalCateRec.setAdapter(cityframesAdapter);
      ...
      /*  long seed = System.nanoTime();
        ...
        if (animalFore.size() > 0) {
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                @Override
                public int getSpanSize(int position) {
                    switch (cityframesAdapter.getItemViewType(position)) {
                        case STRING:
                            return 1;
    ...
    public class CityframesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public CityframesAdapter(Activity activity, ArrayList<Object> animalThumb, ArrayList<Object> animalBack, ArrayList<Object> animalFore) {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            int newkeycount;
            if (keycountcity > 0) {
                newkeycount = oldkeycount + keycountcity;
                    ...
                    holder1.neonCard.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (cityFragmentListener != null) {
                                cityFragmentListener.onCityViewItemClicked(animalBack.get(position).toString(), animalFore.get(position).toString(), position);
                            }
