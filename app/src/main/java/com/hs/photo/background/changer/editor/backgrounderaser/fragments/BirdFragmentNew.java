...
public class BirdFragmentNew extends Fragment {
    ...
    String img1, img2;
    public  static  int keycountbirdnew = 0;
    RecyclerView neonCateRecNew;

    BirdAdapterListenernew birdAdapterListenernew;

    public interface BirdAdapterListenernew {
        void onBirdItemClickednew(String back, String forei, int position);
    }
                        ...
                        if (RemoteConfigValues.getOurRemote().getEnableRewardAfter() != null) {
                            if (!RemoteConfigValues.getOurRemote().getEnableRewardAfter().equals("")) {
                                for (int i = Integer.parseInt(RemoteConfigValues.getOurRemote().getEnableRewardAfter()) + 1; i <= Integer.parseInt(RemoteConfigValues.getOurRemote().getBirdCount()); i++) {
                                    neonThumb.add(RemoteConfigValues.getOurRemote().getBirdUrl() + "bird_thumb_" + i + ".jpg");
                                    neonBack.add(RemoteConfigValues.getOurRemote().getBirdUrl() + "bird_back_" + i + ".png");
                                    neonFore.add(RemoteConfigValues.getOurRemote().getBirdUrl() + "bird_fore_" + i + ".png");
                                }
                            }
                        }
...
//to check and seperate the frames that are downloaded in natureframes list before  key list
        ...
        for (int i = 0; i < neonThumb.size(); i++) {
            ...
            if (img1.contains("https")) {
                ...
                if (backmediaStorageDir.exists() && foremediaStorageDir.exists()) {
                    ...
                    keycountbirdnew = downloadedThumb.size();
                    System.out.println(keycountbirdnew);
                } else {
                    //adding the not downloaded frames
    ...
    private void classAndWidgetIntialize() {
        ...
        BirdframesAdapterNew birdframesAdapterNew = new BirdframesAdapterNew(getActivity(), beforeKeydownloadthumb, beforeKeydownloadback, beforeKeydownloadfore);
        ...
        neonCateRecNew.setAdapter(birdframesAdapterNew);


    }

    public class BirdframesAdapterNew extends RecyclerView.Adapter<BirdframesAdapterNew.ViewHolder> {
        ...
        public BirdframesAdapterNew(Activity activity, ArrayList<String> neonThumb, ArrayList<String> neonBack, ArrayList<String> neonFore) {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            int newkeycount;
            if (keycountbirdnew > 0) {
                newkeycount = oldkeycount + keycountbirdnew;
...
//                        if (position >= Integer.parseInt(RemoteConfigValues.getOurRemote().getEnableRewardAfter())) {
            ...
            holder.neonnewImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (birdAdapterListenernew != null) {
                        birdAdapterListenernew.onBirdItemClickednew(neonBack.get(position), neonFore.get(position), position);
                    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            birdAdapterListenernew = (BirdAdapterListenernew) context;
