...
public class SunsetFragmentNew extends Fragment {
    ...
    String img1, img2;
   public static  int keycountnewsunset = 0;
    RecyclerView neonCateRecNew;

    SunsetAdapterListenernew sunsetAdapterListenernew;
    public interface SunsetAdapterListenernew {
        void onSunsetItemClickednew(String back, String forei,int position);
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (RemoteConfigValues.getOurRemote().getSunsetUrl()!=null){
            if (!RemoteConfigValues.getOurRemote().getSunsetUrl().equals("")){
                if (RemoteConfigValues.getOurRemote().getEnableRewardAfter()!=null){
                    if (!RemoteConfigValues.getOurRemote().getEnableRewardAfter().equals("")){
                        for (int i=1;i<=Integer.parseInt(RemoteConfigValues.getOurRemote().getEnableRewardAfter());i++){
                            beforeKeythumb.add(RemoteConfigValues.getOurRemote().getSunsetUrl()+"sunset_thumb_"+i+".jpg");
                            beforeKeyback.add(RemoteConfigValues.getOurRemote().getSunsetUrl()+"sunset_back_"+i+".png");
                            beforeKeyfore.add(RemoteConfigValues.getOurRemote().getSunsetUrl()+"sunset_fore_"+i+".png");
                        }
        ...
        if (RemoteConfigValues.getOurRemote().getSunsetUrl()!=null){
            if (!RemoteConfigValues.getOurRemote().getSunsetUrl().equals("")){
                if (RemoteConfigValues.getOurRemote().getSunsetCount()!=null){
                    if (!RemoteConfigValues.getOurRemote().getSunsetCount().equals("")){
                        if (RemoteConfigValues.getOurRemote().getEnableRewardAfter()!=null){
                            if (!RemoteConfigValues.getOurRemote().getEnableRewardAfter().equals("")){

                                for (int i=Integer.parseInt(RemoteConfigValues.getOurRemote().getEnableRewardAfter())+1;i<=Integer.parseInt(RemoteConfigValues.getOurRemote().getSunsetCount());i++){
                                    neonThumb.add(RemoteConfigValues.getOurRemote().getSunsetUrl()+"sunset_thumb_"+i+".jpg");
                                    neonBack.add(RemoteConfigValues.getOurRemote().getSunsetUrl()+"sunset_back_"+i+".png");
                                    neonFore.add(RemoteConfigValues.getOurRemote().getSunsetUrl()+"sunset_fore_"+i+".png");
                                }
...
//to check and seperate the frames that are downloaded in natureframes list before  key list
        ...
        for (int i = 0; i < neonThumb.size(); i++) {
            ...
            if (img1.contains("https")) {
                ...
                if (backmediaStorageDir.exists() && foremediaStorageDir.exists()) {
                    ...
                    keycountnewsunset = downloadedThumb.size();
                    System.out.println(keycountnewsunset);
                } else {
                    //adding the not downloaded frames
    ...
    private void classAndWidgetIntialize() {
        ...
        SunsetframesAdapterNew sunsetframesAdapterNew = new SunsetframesAdapterNew(getActivity(), beforeKeydownloadthumb,beforeKeydownloadback,beforeKeydownloadfore);
        ...
        neonCateRecNew.setAdapter(sunsetframesAdapterNew);


    }
    public class SunsetframesAdapterNew  extends RecyclerView.Adapter<SunsetframesAdapterNew.ViewHolder> {
        ...
        public SunsetframesAdapterNew(Activity activity, ArrayList<String> neonThumb, ArrayList<String> neonBack, ArrayList<String> neonFore){
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            int newkeycount;
            if (keycountnewsunset > 0) {
                newkeycount = oldkeycount + keycountnewsunset;
...
//                        if (position>=Integer.parseInt(RemoteConfigValues.getOurRemote().getEnableRewardAfter())){
            ...
            holder.neonnewImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(sunsetAdapterListenernew != null) {
                        sunsetAdapterListenernew.onSunsetItemClickednew(neonBack.get(position),neonFore.get(position),position);
                    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            sunsetAdapterListenernew = (SunsetAdapterListenernew) context;
